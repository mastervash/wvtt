...
const FALLBACK: PackCard[] = [
  ...
  { id: 'shortfuse', name: 'Short Fuse', description: 'Draw until someone blows up. Defuse, dodge and Nope.', flavour: 'scripted', minSeats: 2, maxSeats: 6 },
    ...
    <div className="lobby">
      <div className="lobby-card">
        <div className="lobby-head">
          ...
          {/* The mark is inlined rather than fetched: the app ships no image assets, and
              a lobby that renders before its one icon arrives is not worth a request. */}
          <a
            className="repo-link"
            href="https://github.com/mastervash/wvtt"
            target="_blank"
            rel="noreferrer noopener"
            title="WVTT on GitHub"
            aria-label="WVTT on GitHub"
          >
